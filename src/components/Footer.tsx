        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start mb-12">
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex items-center space-x-4">
                <a href="https://www.instagram.com/motivafurniture?igsh=MTJkOTF2cWxzZnY4ZA==" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-muted hover:text-obsidian focus:text-obsidian transition-colors duration-300">
                  <Instagram size={18} strokeWidth={1.5} />
                </a>
                <a href="https://www.facebook.com/Motivafurniture1?mibextid=wwXIfr&mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-muted hover:text-obsidian focus:text-obsidian transition-colors duration-300">
                  <Facebook size={18} strokeWidth={1.5} />
                </a>
                <a href="https://www.tiktok.com/@motiva.furniture?_r=1&_d=f1edcaek3d9kdf&sec_uid=MS4wLjABAAAAibwtyggqsemWEHKEqYzXsEqDJujHAfeK8r3QeMCl2ODKwgxBTnEkQwHw2cbPI3T1&share_author_id=7491472696518280210&sharer_language=en&source=h5_m&u_code=d22hak2460ke7k&item_" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-muted hover:text-obsidian focus:text-obsidian transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted font-light">
              <li><Link to="/collections" className="hover:text-obsidian focus:text-obsidian transition-colors duration-300">Dining Rooms</Link></li>
              <li><Link to="/collections" className="hover:text-obsidian focus:text-obsidian transition-colors duration-300">Living Sets</Link></li>
              <li><Link to="/collections" className="hover:text-obsidian focus:text-obsidian transition-colors duration-300">Reception</Link></li>
              <li><Link to="/collections" className="hover:text-obsidian focus:text-obsidian transition-colors duration-300">Bedrooms</Link></li>
              <li><Link to="/collections" className="hover:text-obsidian focus:text-obsidian transition-colors duration-300">L-Shape</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted font-light mb-6">
              <li><Link to="/about" className="hover:text-obsidian focus:text-obsidian transition-colors duration-300">Client Journal</Link></li>
            ...
            <Link to="/contact" className="inline-flex items-center text-sm text-obsidian/80 hover:text-obsidian focus:text-obsidian transition-colors">
              Contact Us
